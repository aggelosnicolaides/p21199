...
def axiomatikos(axg, axs, vag, vas):
    ...
    if ((axs + axg) % 2 == 1) & ((vas + vag) % 2 == 1):  # mavra tetragwna
        ...
        if ((axs - axg == 1) & (vas - vag == 1)) or ((axg - axs == 1) & (vag - vas == 1)) or (
                (axg - axs == 3) & (vag - vas == 3)) or ((axs - axg == 3) & (vas - vag == 3)) or (
                (axg - axs == 5) & (vag - vas == 5)) or ((axg - axs == 5) & (vag - vas == 5)) or (
                (axs + axg == 11) & (vas + vag == 11)) or ((axs + axg == 3) & (vas + vag == 3)) or (
                (axs + axg == 5) & (vas + vag == 5)) or ((axs + axg == 7) & (vas + vag == 7)) or (
                (axs + axg == 9) & (vas + vag == 9)) or ((axs + axg == 13) & (vas + vag == 13)) or (
                (axs + axg == 15) & (vas + vag == 15)):
            kerdise = True

    else:  # lefka tetragwna

        if ((axs - axg == 0) & (vas - vag == 0)) or ((axg - axs == 2) & (vag - vas == 2)) or (
                (axg - axs == 4) & (vag - vas == 4)) or ((axg - axs == 6) & (vag - vas == 6)) or (
                (axs - axg == 2) & (vas - vag == 2)) or ((axs - axg == 4) & (vas - vag == 4)) or (
                (axs - axg == 6) & (vas - vag == 6)) or ((axs + axg == 4) & (vas + vag == 4)) or (
                (axs + axg == 6) & (vas + vag == 6)) or ((axs + axg == 8) & (vas + vag == 8)) or (
                (axs + axg == 10) & (vas + vag == 10)) or ((axs + axg == 12) & (vas + vag == 12)) or (
                (axs + axg == 14) & (vas + vag == 14)):
            kerdise = True
